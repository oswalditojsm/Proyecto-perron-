...
(function () {
    ...
    // El script puede cargarse desde el <head> (antes de que exista
    // document.body), así que esperamos a que el DOM esté listo antes de
    // tocar nada de la página. Si ya está listo, arrancamos de una vez.
